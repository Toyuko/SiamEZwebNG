...
export type FuseSearchableService = DisplayService & {
  categoryKey: string;
...
export function buildFuseSearchableServices(
  services: DisplayService[],
  categoryLabels: Record<string, string>
): FuseSearchableService[] {
...
export function useServiceFuseSearch(
  services: DisplayService[],
  query: string,
  categoryLabels: Record<string, string>
): FuseSearchableService[] {
...
export function groupServicesByCategory(
  results: FuseSearchableService[]
): { category: string; items: FuseSearchableService[] }[] {
  const map = new Map<string, FuseSearchableService[]>();
