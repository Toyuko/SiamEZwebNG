...
-- CreateIndex
CREATE INDEX "account_deletion_requests_email_status_idx" ON "account_deletion_requests"("email", "status");
...
-- CreateIndex
CREATE INDEX "account_deletion_audit_logs_request_id_created_at_idx" ON "account_deletion_audit_logs"("request_id", "created_at");

-- CreateIndex
CREATE INDEX "account_deletion_audit_logs_actor_id_created_at_idx" ON "account_deletion_audit_logs"("actor_id", "created_at");
