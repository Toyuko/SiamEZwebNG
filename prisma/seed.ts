...
const services = [
  ...
  },
  {
    ...
    shortDescription:
      "Buy or sell cars and motorcycles in Thailand with full negotiation, paperwork, and registration support — quote-based pricing.",
    description:
      "SiamEZ Auto & Bike Finder helps you buy or sell cars, motorcycles, vans, and big bikes in Thailand. We handle sourcing, negotiation, paperwork, and registration with transparent support for locals and expats. Service fees are quoted per vehicle and request.",
    type: "quote" as const,
    priceAmount: null,
    priceCurrency: "THB",
    sortOrder: 8,
  },
  {
    ...
    description:
      "Professional vehicle registration assistance across Thailand: ownership transfers, tax and insurance renewals, plate changes, book updates, and lost book replacement. Bangkok one-day processing for qualifying BKK-plated cars and motorcycles; other provinces quoted on inquiry.",
    type: "quote" as const,
    sortOrder: 9,
  },
  {
